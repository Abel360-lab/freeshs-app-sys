    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('REVIEWER', 'Reviewer'), ('SUPPLIER', 'Supplier')], default='SUPPLIER', help_text='User role determining access permissions', max_length=20)),
